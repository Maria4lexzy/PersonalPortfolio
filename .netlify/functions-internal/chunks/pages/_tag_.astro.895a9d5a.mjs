...
async function getStaticPaths() {
  const allPosts = await Astro.glob(/* #__PURE__ */ Object.assign({"../projects/artcaffe.md": () => import('./artcaffe.md.caca6d3e.mjs').then(n => n.c),"../projects/portfolioProject.md": () => import('./portfolioProject.md.70b5b575.mjs')}), () => "../projects/*.md");
  const uniqueTags = [
