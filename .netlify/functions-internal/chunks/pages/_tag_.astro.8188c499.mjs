/* empty css                        */import { c as createAstro, a as createComponent, r as renderTemplate, b as addAttribute, s as spreadAttributes, u as unescapeHTML, d as renderComponent, e as renderHead, m as maybeRenderHead, f as renderSlot } from '../astro.713e64d5.mjs';
/* empty css                                    */
...
const $$Footer = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Footer;
  return renderTemplate`${maybeRenderHead()}<footer id="footer" class="backdrop-filter backdrop-blur-lg bg-primary-light dark:bg-secondary/95 w-full p-4 rounded-t-xl shadow-xl lg:space-y-8">
...
async function getStaticPaths() {
  const allPosts = await Astro.glob(/* #__PURE__ */ Object.assign({"../projects/angularProject.md": () => import('./angularProject.md.09aec0f0.mjs').then(n => n.c),"../projects/artcaffe.md": () => import('./artcaffe.md.e9edb7b0.mjs'),"../projects/portfolioProject.md": () => import('./portfolioProject.md.82f17626.mjs')}), () => "../projects/*.md");
  const uniqueTags = [
