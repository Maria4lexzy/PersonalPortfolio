...
import { P as Pill } from './angularProject.md.7d657782.mjs';
import { b as $$LayoutHeader } from './_technology_.astro.4ff51612.mjs';
import 'cookie';
import 'kleur/colors';
    ...
    <div class="header flex p-5 my-4 bg-green-600 justify-between w-full">
      ...
      <div class="flex gap-x-4 items-center p-2 bg-green-300">
        ...
        <a href="tel:91 15 47 99" target="_self" class="cursor-pointer">
          ${renderComponent($$result2, "Pill", Pill, { "iconSrc": "/images/phone.svg", "description": "Give me a call" })}
        </a>
        <a href="mailto:mariafailli42@gmail.com" target="_self" class="cursor-pointer">
          ${renderComponent($$result2, "Pill", Pill, { "iconSrc": "/images/email.svg", "description": "Send me an email" })}
        </a>
      </div>
      <!-- socials & contact -->
    </div>
