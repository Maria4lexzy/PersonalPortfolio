...
const $$AboutSection = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "CardLayout", $$CardLayout, { "id": "about", "classStyle": "flex flex-col md:flex-row md:gap-8 content-center" }, {
...
const $$SkillsSection = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "CardLayout", $$CardLayout, { "id": "skills", "classStyle": "" }, {
    "default": ($$result2) => renderTemplate`
...
const $$LanguageSection = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "CardLayout", $$CardLayout, { "id": "languages", "classStyles": "" }, {
    "default": ($$result2) => renderTemplate`
...
const $$EducationSection = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "CardLayout", $$CardLayout, { "id": "education", "classStyle": "flex flex-col md:flex-row md:gap-4 " }, {
    "default": ($$result2) => renderTemplate`
...
const $$ExperienceSection = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "CardLayout", $$CardLayout, { "id": "exp", "classStyle": "flex flex-col md:flex-row md:gap-4" }, {
    "default": ($$result2) => renderTemplate`
  ${maybeRenderHead()}<div class="flex flex-col gap-4">
...
const $$ProjectSection = createComponent(async ($$result, $$props, $$slots) => {
  ...
  ${allProjects.map((project) => renderTemplate`${renderComponent($$result2, "Fragment", Fragment$1, {}, {
      "default": ($$result3) => renderTemplate`
        ${maybeRenderHead()}<div class="flex flex-col gap-8">
          <div class="flex flex-col gap-3 ">
            ...
            <div class="flex flex-col gap-3">
              ${renderComponent($$result3, "Fragment", Fragment$1, {}, {
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "pageTitle": title, "seoTitle": seoTitle, "seoDescription": seoDescription, "class": "astro-4MAE3WQV" }, {
    "default": ($$result2) => renderTemplate`
  ${maybeRenderHead()}<div class="tags astro-4MAE3WQV">
    ${technologies.map((tech) => renderTemplate`${renderComponent($$result2, "Fragment", Fragment$1, { "class": "astro-4MAE3WQV" }, {
      "default": ($$result3) => renderTemplate`
