...
import { a as $$LinkCode, $ as $$BaseLayout } from './_technology_.astro.19f40c17.mjs';
import { P as Pill, a as $$Subtitle, b as $$CardLayout } from './angularProject.md.a526e818.mjs';
...
const $$ProjectSection = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const allProjects = await Astro2.glob(/* #__PURE__ */ Object.assign({"../pages/projects/angularProject.md": () => import('./angularProject.md.a526e818.mjs').then(n => n.c),"../pages/projects/artcaffe.md": () => import('./artcaffe.md.a220560f.mjs'),"../pages/projects/portfolioProject.md": () => import('./portfolioProject.md.9cd8fcf8.mjs'),"../pages/projects/scrollAnimation.md": () => import('./scrollAnimation.md.1798f05a.mjs')}), () => "../pages/projects/*.md");
...
const $$Index$1 = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Index$1;
  const allProjects = await Astro2.glob(/* #__PURE__ */ Object.assign({"../projects/angularProject.md": () => import('./angularProject.md.a526e818.mjs').then(n => n.c),"../projects/artcaffe.md": () => import('./artcaffe.md.a220560f.mjs'),"../projects/portfolioProject.md": () => import('./portfolioProject.md.9cd8fcf8.mjs'),"../projects/scrollAnimation.md": () => import('./scrollAnimation.md.1798f05a.mjs')}), () => "../projects/*.md");
  const technologies = [
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Index;
  const allProjects = await Astro2.glob(/* #__PURE__ */ Object.assign({"./angularProject.md": () => import('./angularProject.md.a526e818.mjs').then(n => n.c),"./artcaffe.md": () => import('./artcaffe.md.a220560f.mjs'),"./portfolioProject.md": () => import('./portfolioProject.md.9cd8fcf8.mjs'),"./scrollAnimation.md": () => import('./scrollAnimation.md.1798f05a.mjs')}), () => "../projects/*.md");
