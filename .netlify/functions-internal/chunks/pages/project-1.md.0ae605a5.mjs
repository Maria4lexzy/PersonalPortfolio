...
const $$MarkdownProjectLayout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "pageTitle": frontmatter.title, "seoTitle": seoTitle, "seoDescription": seoDescription, "class": "astro-LFQ5PVLT" }, { "default": ($$result2) => renderTemplate`
...
const images = {
				...
				const frontmatter = {"layout":"../../layouts/MarkdownProjectLayout.astro","title":"Project Showcase: Amazing Website","pubDate":"2023-07-15T00:00:00.000Z","description":"Introducing our latest project - a stunning and interactive website.","author":"Your Name","image":{"src":"/images/maria.jpg","alt":"Preview of the Amazing Website project."},"tags":["web development","interactive design","software projects"]};
