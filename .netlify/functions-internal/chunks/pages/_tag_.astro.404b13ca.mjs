...
const $$LinkCode = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<a${addAttribute(url, "href")}${addAttribute(`${classItems} font-sourceCode hover: dark:text-primary-text dark:text-secondary-text text-primary-text dark:text-secondary-text-dark active: dark:text-primary-text dark:text-secondary-text text-primary-text dark:text-secondary-text-dark astro-WDYU34QM`, "class")}${addAttribute(urlTarget ? urlTarget : "", "target")}>${content}</a>`;
