...
import { P as Pill, a as $$Subtitle, c as $$CardLayout, d as $$LinkCode, b as $$BaseLayout } from './angularProject.md.53c16156.mjs';
...
const $$ProjectSection = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const allProjects = await Astro2.glob(/* #__PURE__ */ Object.assign({"../pages/projects/angularProject.md": () => import('./angularProject.md.53c16156.mjs').then(n => n.f),"../pages/projects/artcaffe.md": () => import('./artcaffe.md.dcdd68b3.mjs'),"../pages/projects/intersectionObserver.md": () => import('./intersectionObserver.md.08f02382.mjs'),"../pages/projects/portfolioProject.md": () => import('./portfolioProject.md.eb0b2e5b.mjs')}), () => "../pages/projects/*.md");
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Index;
  const allProjects = await Astro2.glob(/* #__PURE__ */ Object.assign({"./angularProject.md": () => import('./angularProject.md.53c16156.mjs').then(n => n.f),"./artcaffe.md": () => import('./artcaffe.md.dcdd68b3.mjs'),"./intersectionObserver.md": () => import('./intersectionObserver.md.08f02382.mjs'),"./portfolioProject.md": () => import('./portfolioProject.md.eb0b2e5b.mjs')}), () => "../projects/*.md");
