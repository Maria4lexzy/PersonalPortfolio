...
const $$LinkCode = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<a${addAttribute(url, "href")}${addAttribute(`${classItems} font-sourceCode hover:text-myTextBlue active:text-myTextBlue astro-WDYU34QM`, "class")}>${content}</a>`;
