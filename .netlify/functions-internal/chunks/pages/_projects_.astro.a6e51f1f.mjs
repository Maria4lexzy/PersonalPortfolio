...
const $$LinkCode = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<a${addAttribute(url, "href")}${addAttribute(`${classItems} font-sourceCode hover: dark:text-primary-text dark:text-secondary-text text-primary-text dark:text-secondary-text-dark active: dark:text-primary-text dark:text-secondary-text text-primary-text dark:text-secondary-text-dark astro-WDYU34QM`, "class")}>${content}</a>`;
...
const $$BaseLayout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  ${renderComponent($$result, "LayoutHeader", $$LayoutHeader, { "pageTitle": pageTitle, "seoTitle": seoTitle, "seoDescription": seoDescription, "class": "astro-37FXCHFA" })}
  ${maybeRenderHead()}<body class="bg-primary/80 dark:bg-secondary-dark/90 text-neutral-700 dark:text-neutral-300 font-quicksand transition-colors delay-150 ease-custom-bezier duration-500 astro-37FXCHFA">
