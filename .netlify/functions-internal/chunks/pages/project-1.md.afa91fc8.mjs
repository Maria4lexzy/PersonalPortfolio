...
const frontmatter = { "layout": "../../layouts/MarkdownProjectLayout.astro", "title": "Project Showcase: Amazing Website", "role": "frontend developer", "teamNum": "4", "organization": "SDU University", "description": "Introducing our latest project - a stunning and interactive website.", "images": [{ "src": "/images/profile.jpeg", "alt": "Preview of the Amazing Website project." }, { "src": "/images/artcaffe_small.png", "alt": "Another image for the project." }], "technologies": ["Javascript", "interactive design", "software projects"] };
