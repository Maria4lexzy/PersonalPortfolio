/* empty css                        */import { c as createAstro, a as createComponent, r as renderTemplate, m as maybeRenderHead, d as renderComponent, _ as __astro_tag_component__, F as Fragment, b as addAttribute } from '../astro.6fa2bed6.mjs';
import { a as $$LinkCode, $ as $$BaseLayout } from './_tag_.astro.895a9d5a.mjs';
import { P as Pill, $ as $$Subtitle, a as $$CardLayout } from './artcaffe.md.caca6d3e.mjs';
  ...
  <div class="mx-auto md:flex md:flex-col md:py-2 text-center md:text-left">
    ...
    <div class="mt-4 md:mt-0 md:gap-y-2">
      ...
      <p class="mt-4 text-sm lg:text-base text-justify">
        ...
        traveling✈️ and trying new food🍜. So far, I've been to <span class="text-primary-text dark:text-secondary-text">15 countries</span> and two continents, and I look forward to exploring more places.
      </p>
...
const $$ProjectSection = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const allProjects = await Astro2.glob(/* #__PURE__ */ Object.assign({"../pages/projects/artcaffe.md": () => import('./artcaffe.md.caca6d3e.mjs').then(n => n.c),"../pages/projects/portfolioProject.md": () => import('./portfolioProject.md.70b5b575.mjs')}), () => "../pages/projects/*.md");
  ...
  ${allProjects.map((project) => renderTemplate`${renderComponent($$result2, "Fragment", Fragment, {}, { "default": ($$result3) => renderTemplate`
        ${maybeRenderHead()}<div class="flex flex-col gap-8">
      ...
      ` })}`)}${renderComponent($$result2, "Subtitle", $$Subtitle, { "subTitle": "more comming soon after my vacation \u{1F60E}\u2708\uFE0F" })}
` })}`;
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Index;
  const allProjects = await Astro2.glob(/* #__PURE__ */ Object.assign({"../projects/artcaffe.md": () => import('./artcaffe.md.caca6d3e.mjs').then(n => n.c),"../projects/portfolioProject.md": () => import('./portfolioProject.md.70b5b575.mjs')}), () => "../projects/*.md");
  const technologies = [
