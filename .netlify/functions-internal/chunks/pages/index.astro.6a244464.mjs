/* empty css                        */import { c as createAstro, a as createComponent, r as renderTemplate, m as maybeRenderHead, d as renderComponent, F as Fragment, b as addAttribute } from '../astro.713e64d5.mjs';
import { a as $$LinkCode, $ as $$BaseLayout } from './_tag_.astro.8188c499.mjs';
import { P as Pill, a as $$Subtitle, b as $$CardLayout } from './angularProject.md.09aec0f0.mjs';
      ...
      <div class="flex flex-col lg:flex-row nowrap gap-x-4 gap-y-1 md:gap-x-8">
        <div class="flex flex-row gap-1 justify-center md:justify-normal">
          <a href="mailto:mariafailli42@gmail.com" class="text-sm font-normal leading-relaxed sm:text-base" target="_self">
            ${renderComponent($$result2, "Pill", Pill, { "iconSrc": "/images/email.svg", "description": "Send me an email", "classListItems": "hover:animate-pulse" })}
          </a>
        </div>
        <div class="flex flex-row gap-1 justify-center md:justify-normal">
          <a href="tel:91 15 47 99" class="text-sm font-normal leading-relaxed sm:text-base" target="_self">
            ${renderComponent($$result2, "Pill", Pill, { "iconSrc": "/images/phone.svg", "classListItems": "hover:animate-pulse", "description": "Give me a call" })}
          </a>
        </div>
      </div>

      <p class="mt-4 text-sm lg:text-base text-justify">
        Greetings Observer👋, I'm Maria. I like developing <span class="text-primary-text dark:text-secondary-text">well-structured</span>, <span class="text-primary-text dark:text-secondary-text">reusable</span>, and <span class="text-primary-text dark:text-secondary-text">maintainable</span> software solutions. What I enjoy about the software world is the constant
        evolution of technologies and tools, always offering new opportunities to
        learn and create more efficient solutions. My journey in technology is driven
        by
        <span class="text-primary-text dark:text-secondary-text">curiosity</span> and desire to make a positive impact through
        <span class="text-primary-text dark:text-secondary-text">innovation</span>. In my free time, you'll find me immersed in DIY projects, from
        ...
        <div class="flex gap-x-4 gap-y-1 md:gap-x-8 justify-center">
          <div class="flex flex-row gap-1 justify-center md:justify-normal">
            <a href="https://github.com/Maria4lexzy">
              ${renderComponent($$result2, "Pill", Pill, { "iconSrc": "/images/github.svg" })}
            </a>
          </div>
          <div class="flex flex-row gap-1 justify-center md:justify-normal">
            <a href="https://www.linkedin.com/in/maria-louisa-failli/">
              ${renderComponent($$result2, "Pill", Pill, { "iconSrc": "/images/linkedin.svg" })}
            </a>
          </div>
          <div class="flex flex-row gap-1 justify-center md:justify-normal">
            <a href="https://www.linkedin.com/in/https://maria-louisa.com/projects/project-1/">
              ${renderComponent($$result2, "Pill", Pill, { "iconSrc": "/images/portfolio.svg" })}
            </a>
          </div>
        </div>
      </div>
  ...
  ${maybeRenderHead()}<div class="flex flex-col gap-4">
    ...
    <div class="flex flex-row gap-8">
      <div class="hidden md:block">
        <img src="/images/companies/SDU_B.webp" alt="SDU logo" decoding="async" loading="lazy" class="rounded-lg w-16 md:w-28 h-auto">
    ...
    <div class="flex flex-row gap-8">
      <div class="hidden md:block">
        <img src="/images/companies/VIA.webp" alt="VIA University College" decoding="async" loading="lazy" class="rounded-lg w-16 md:w-28 h-auto">
      </div>
      <div class="flex flex-col gap-1">
        <h1 class="capitalize text-lg font-semibold">
...
const $$ExperienceSection = createComponent(async ($$result, $$props, $$slots) => {
  ...
  ${maybeRenderHead()}<div class="flex flex-col gap-4">
    ...
    <div class="flex flex-row gap-8">
      <div class="hidden md:block">
        <img src="/images/companies/startupCentral.webp" alt="Startup Central Logo" decoding="async" loading="lazy" class="rounded-lg w-16 md:w-28 h-auto">
      </div>
      <div class="flex flex-col gap-1">
    ...
    <div class="flex flex-row gap-8">
      <div class="hidden md:block">
        <img src="/images/companies/Biamp-Logo.webp" alt="Biamp Logo" decoding="async" loading="lazy" class="rounded-lg w-16 md:w-28 h-auto">
      </div>
      <div class="flex flex-col gap-1">
        <h1 class="tracking-wide capitalize text-xl font-semibold">
          Biamp Denmark
    ...
    <div class="flex flex-row gap-8">
      <div class="hidden md:block">
        <img src="/images/companies/kakring-el-logo.webp" alt="Klakring El Logo" decoding="async" loading="lazy" class="rounded-lg w-16 md:w-28 h-auto">
      </div>
      <div class="flex flex-col gap-1">
        <h1 class="tracking-wide capitalize text-xl font-semibold">
          Klakring El Denmark
    ...
    <div class="flex flex-row gap-8">
      <div class="hidden md:block">
        <img src="/images/companies/geltec.webp" alt="Biamp Logo" decoding="async" loading="lazy" class="rounded-lg w-16 md:w-28 h-auto">
      </div>
      <div class="flex flex-col gap-1">
        <h1 class="tracking-wide capitalize text-xl font-semibold">
    ...
    <div class="flex flex-row gap-8">
      <div class="hidden md:block">
        <img src="/images/companies/lens-logo.webp" alt="LENS Logo" decoding="async" loading="lazy" class="rounded-lg w-16 md:w-28 h-auto">
      </div>
      <div class="flex flex-col gap-1">
        <h1 class="tracking-wide capitalize text-xl font-semibold">
...
const $$ProjectSection = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const allProjects = await Astro2.glob(/* #__PURE__ */ Object.assign({"../pages/projects/angularProject.md": () => import('./angularProject.md.09aec0f0.mjs').then(n => n.c),"../pages/projects/artcaffe.md": () => import('./artcaffe.md.e9edb7b0.mjs'),"../pages/projects/portfolioProject.md": () => import('./portfolioProject.md.82f17626.mjs')}), () => "../pages/projects/*.md");
            ...
            <div class="flex gap-2 justify-between w-full">
              ...
              <div class="flex gap-3 flex-wrap sm:flex-nowrap">
                ${project.frontmatter.externals.map((external) => renderTemplate`<a${addAttribute(external.url, "href")} class="cursor-pointer" target="_blank">
                    ${renderComponent($$result3, "Pill", Pill, { "iconSrc": `../images/${external.name}.svg`, "description": "demo" })}
                  </a>`)}
              </div>
            </div>
            <div class="flex flex-col gap-3">
...
const $$file$2 = "C:/Users/maria/Documents/GitHub/MyPortfolio/maria/src/pages/index.astro";
const $$url$2 = "";
...
const $$Index$1 = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Index$1;
  const allProjects = await Astro2.glob(/* #__PURE__ */ Object.assign({"../projects/angularProject.md": () => import('./angularProject.md.09aec0f0.mjs').then(n => n.c),"../projects/artcaffe.md": () => import('./artcaffe.md.e9edb7b0.mjs'),"../projects/portfolioProject.md": () => import('./portfolioProject.md.82f17626.mjs')}), () => "../projects/*.md");
  const technologies = [
  ...
  ${maybeRenderHead()}<div class="tags astro-4MAE3WQV">
    ${technologies.map((tech) => renderTemplate`${renderComponent($$result2, "Fragment", Fragment, { "class": "astro-4MAE3WQV" }, { "default": ($$result3) => renderTemplate`
...
const $$file$1 = "C:/Users/maria/Documents/GitHub/MyPortfolio/maria/src/pages/technologies/index.astro";
const $$url$1 = "/technologies";
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Index;
  const allProjects = await Astro2.glob(/* #__PURE__ */ Object.assign({"./angularProject.md": () => import('./angularProject.md.09aec0f0.mjs').then(n => n.c),"./artcaffe.md": () => import('./artcaffe.md.e9edb7b0.mjs'),"./portfolioProject.md": () => import('./portfolioProject.md.82f17626.mjs')}), () => "../projects/*.md");
  ...
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "pageTitle": pageTitle, "seoTitle": seoTitle, "seoDescription": seoDescription }, { "default": ($$result2) => renderTemplate`
  ${renderComponent($$result2, "CardLayout", $$CardLayout, { "id": "projects" }, { "default": ($$result3) => renderTemplate`
            ...
            <div class="flex flex-col gap-3 ">
              ...
              <div class="flex flex-col gap-3">
                ...
                <div>
                  ...
                  <div class="flex flex-wrap gap-4">
                    ${project.frontmatter.technologies.map((tech) => renderTemplate`${renderComponent($$result4, "Pill", Pill, { "iconSrc": `images/${tech}.svg`, "description": tech })}`)}
                  </div>
                </div>
              </div>
            </div>
