...
const $$Title = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<!-- <div class='flex flex-row items-center'> -->${maybeRenderHead()}<h1 class="capitalize text-xl font-extrabold  dark:text-primary-text dark:text-secondary-text text-primary-text dark:text-secondary-text-dark font-sourceCode">
  ${`{ ${title} }`}
</h1>
...
const $$CardLayout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<section${addAttribute(dataAos, "data-aos")}${addAttribute(id, "id")}${addAttribute(` ${classStyle} section my-4 backdrop-filter backdrop-blur-lg
  ...
  ${maybeRenderHead()}<div class="flex flex-col gap-4">
    ...
    <div class="flex flex-row gap-4">
      <span class="h-12 w-12 text-white bg-slate-100">
        <img src="/images/SDU.png" alt="Maria Failli" decoding="async" loading="lazy" class="rounded-lg h-12 w-auto">
...
const $$ProjectSection = createComponent(async ($$result, $$props, $$slots) => {
  ...
  await Astro2.glob(/* #__PURE__ */ Object.assign({ "../pages/projects/project-1.md": () => import('./project-1.md.afa91fc8.mjs') }), () => "../pages/projects/*.md");
  return renderTemplate`${renderComponent($$result, "CardLayout", $$CardLayout, { "dataAos": "fade-left", "id": "projects", "classStyles": "" }, {
    "default": ($$result2) => renderTemplate`
  ${renderComponent($$result2, "Title", $$Title, { "title": "Projects" })}

  ${maybeRenderHead()}<div class="container mx-auto py-8">
      ...
      <div>
        ...
        <div class="">
          <div class="flex flex-row gap-2">
            <span class="text-neutral-950 text-base dark:text-neutral-100">My role</span>
            <p class="text-neutral-500 capitalize">xxx</p>
          </div>
        </div>
      </div>
    ...
    <div>
      ...
      <div>
        ...
        <div class="flex flex-wrap gap-4">
          ${renderComponent($$result2, "Pill", Pill, { "iconSrc": "images/firebase.svg", "description": "Firebase" })}
          ${renderComponent($$result2, "Pill", Pill, { "iconSrc": "images/gallery.svg", "description": "Firebase" })}
          <img src="images/github.svg" class="fill-green-400">
        </div>
      </div>
    </div>
  </div>
  ...
  <button type="button" class="bg-green-400 p-3" id="myGallery">Open Gallery</button>
` })}`;
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "pageTitle": pageTitle, "seoTitle": seoTitle, "seoDescription": seoDescription }, {
    "default": ($$result2) => renderTemplate`
  ${maybeRenderHead()}<div class="flex w-full">
    <h3>TODO</h3>
    <ul>
      <li>Add splash screen</li>
      <li>Finish projects section</li>
      <li>Add animations</li>
      <li>Fix colors</li>
      <li>Add "active" to navbar</li>
      <li>Change cursor to something cool</li>
      <li>remove nano gallery</li>
      <li>add photo swipe</li>
      <li>add button click to open gallery in projects section</li>
    </ul>
  </div>
