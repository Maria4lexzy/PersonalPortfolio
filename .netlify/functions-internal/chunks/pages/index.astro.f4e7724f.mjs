...
import { I as IconPill, a as $$Subtitle, b as $$CardLayout, c as $$LinkCode, d as $$BaseLayout } from './AzureProject.md.ab5fe198.mjs';
  ...
  <div class="mx-auto md:flex md:flex-col md:py-2 text-center md:text-left">
    ...
    <div class="mt-4 md:mt-0 md:gap-y-2">
      ...
      <p class="mt-4 text-sm lg:text-base text-justify">
        Hey there👋, I'm Maria. I like developing <span class="text-primary-text dark:text-secondary-text">well-structured</span>, <span class="text-primary-text dark:text-secondary-text">reusable</span>, and <span class="text-primary-text dark:text-secondary-text">maintainable</span> software solutions. In the world of software, learning never stops, I'm
...
const $$ProjectSection = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const allProjects = await Astro2.glob(/* #__PURE__ */ Object.assign({"../pages/projects/AzureProject.md": () => import('./AzureProject.md.ab5fe198.mjs').then(n => n.A),"../pages/projects/angularProject.md": () => import('./angularProject.md.0b228b81.mjs'),"../pages/projects/artcaffe.md": () => import('./artcaffe.md.f15d8a24.mjs'),"../pages/projects/intersectionObserver.md": () => import('./intersectionObserver.md.90f87bfc.mjs'),"../pages/projects/portfolioProject.md": () => import('./portfolioProject.md.f9706299.mjs'),"../pages/projects/weatherServer.md": () => import('./weatherServer.md.28f1f5d6.mjs')}), () => "../pages/projects/*.md");
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Index;
  const allProjects = await Astro2.glob(/* #__PURE__ */ Object.assign({"./AzureProject.md": () => import('./AzureProject.md.ab5fe198.mjs').then(n => n.A),"./angularProject.md": () => import('./angularProject.md.0b228b81.mjs'),"./artcaffe.md": () => import('./artcaffe.md.f15d8a24.mjs'),"./intersectionObserver.md": () => import('./intersectionObserver.md.90f87bfc.mjs'),"./portfolioProject.md": () => import('./portfolioProject.md.f9706299.mjs'),"./weatherServer.md": () => import('./weatherServer.md.28f1f5d6.mjs')}), () => "../projects/*.md");
