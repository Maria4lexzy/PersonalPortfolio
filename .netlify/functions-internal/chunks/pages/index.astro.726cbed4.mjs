...
import { a as $$LinkCode, $ as $$BaseLayout } from './_technology_.astro.4ff51612.mjs';
import { P as Pill, a as $$Subtitle, b as $$CardLayout } from './angularProject.md.7d657782.mjs';
...
const $$Index$1 = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Index$1;
  const allProjects = await Astro2.glob(/* #__PURE__ */ Object.assign({"../projects/angularProject.md": () => import('./angularProject.md.7d657782.mjs').then(n => n.c),"../projects/artcaffe.md": () => import('./artcaffe.md.a453def8.mjs'),"../projects/intersectionObserver.md": () => import('./intersectionObserver.md.d076c81b.mjs'),"../projects/portfolioProject.md": () => import('./portfolioProject.md.b61c6424.mjs')}), () => "../projects/*.md");
  const technologies = [
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Index;
  const allProjects = await Astro2.glob(/* #__PURE__ */ Object.assign({"./angularProject.md": () => import('./angularProject.md.7d657782.mjs').then(n => n.c),"./artcaffe.md": () => import('./artcaffe.md.a453def8.mjs'),"./intersectionObserver.md": () => import('./intersectionObserver.md.d076c81b.mjs'),"./portfolioProject.md": () => import('./portfolioProject.md.b61c6424.mjs')}), () => "../projects/*.md");
