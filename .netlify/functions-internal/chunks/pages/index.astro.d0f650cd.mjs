...
import { P as Pill, a as $$Subtitle, c as $$CardLayout, d as $$LinkCode, b as $$BaseLayout } from './angularProject.md.db12a2a3.mjs';
...
const $$ProjectSection = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const allProjects = await Astro2.glob(/* #__PURE__ */ Object.assign({"../pages/projects/angularProject.md": () => import('./angularProject.md.db12a2a3.mjs').then(n => n.f),"../pages/projects/artcaffe.md": () => import('./artcaffe.md.ddc78d99.mjs'),"../pages/projects/intersectionObserver.md": () => import('./intersectionObserver.md.58d228ab.mjs'),"../pages/projects/portfolioProject.md": () => import('./portfolioProject.md.3aab7727.mjs')}), () => "../pages/projects/*.md");
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Index;
  const allProjects = await Astro2.glob(/* #__PURE__ */ Object.assign({"./angularProject.md": () => import('./angularProject.md.db12a2a3.mjs').then(n => n.f),"./artcaffe.md": () => import('./artcaffe.md.ddc78d99.mjs'),"./intersectionObserver.md": () => import('./intersectionObserver.md.58d228ab.mjs'),"./portfolioProject.md": () => import('./portfolioProject.md.3aab7727.mjs')}), () => "../projects/*.md");
